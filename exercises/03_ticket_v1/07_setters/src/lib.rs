...
impl Ticket {
    pub fn new(title: String, description: String, status: String) -> Ticket {
        // title, description and status are borrowed (bc ownership is not necessary here)
    ...
    pub fn set_title(&mut self, new_title: String) {
        // new_title is borrowed (bc ownership is not necessary here)
        validate_title(&new_title);
        self.title = new_title;
    }

    pub fn set_description(&mut self, new_description: String) {
        // new_description is borrowed (bc ownership is not necessary here)
        validate_description(&new_description);
        self.description = new_description;
    }

    pub fn set_status(&mut self, new_status: String) {
        // new_status is borrowed (bc ownership is not necessary here)
