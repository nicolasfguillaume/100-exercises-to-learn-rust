...
impl IntoIterator for TicketStore {
    type Item = Ticket; // The type of the items being iterated over
    type IntoIter = std::vec::IntoIter<Ticket>; // The type of the iterator for Vec

    // The into_iter method converts the collection into an iterator
    fn into_iter(self) -> Self::IntoIter {
        self.tickets.into_iter() // Convert Vec<Ticket> into its iterator
    }
}
